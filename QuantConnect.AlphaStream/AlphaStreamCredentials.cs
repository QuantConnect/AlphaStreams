...
namespace QuantConnect.AlphaStream
{
    ...
    /// </summary>
    public class AlphaStreamCredentials
    {
        ...
        public AlphaStreamCredentials()
        {
        }

        public AlphaStreamCredentials(string hostName,
            int port,
            string username,
            string password,
            string exchangeName,
        ...
        /// <summary>
        /// Creates a new instance based on the config.json file
        /// </summary>
        public static AlphaStreamCredentials FromConfiguration()
        {
        ...
        /// <summary>
        /// Creates a new instance based on the provided config json file
        /// </summary>
