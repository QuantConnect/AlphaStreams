...
{
    // This file was obtained via the QuantConnect LEAN open source project on 2018.03.09. License header purposefully included.
    // https://github.com/QuantConnect/Lean/blob/d0b282b778da02c169164f750bc6d4265810591f/Common/Util/TypeChangeJsonConverter.cs
    ...
    public abstract class TypeChangeJsonConverter<T, TResult> : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var targetType = target?.GetType() ?? typeof(T);
